        ...
        <React.Fragment>
            ...
            <div className="input-group w-75 mb-2">
                <input 
                    ...
                    value={email}
                    name="email"
                    onChange={event =>{this.handleOnChangeFilter(event.target.name, event.target.value)}} 
                />
                <input 
                    type="text" 
                    className="form-control" 
                ...
                <input 
                    ...
                    onChange={event =>{this.handleOnChangeFilter(event.target.name, event.target.value)}}
                />
                <button onClick={this.handleOnClickApproveFilter} className="btn btn-sm btn-primary ml-1">Approves</button>
            </div>
            ...
            <UserModal
                user={user}
                handleExitModal={this.handleExitUserModal}
            />
            <BusinessModal
                business={business}
                handleExitModal={this.handleExitBusinessModal}
            />
            <DescriptionModal
